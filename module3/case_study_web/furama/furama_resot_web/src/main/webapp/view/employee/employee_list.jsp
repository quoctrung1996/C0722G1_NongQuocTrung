...
<div class="row">
    <div class="col" style="background-color: gainsboro;margin-top: 5px;">
        <h1 style="display: inline;margin-left: 660px">Employee Service</h1>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal1" style="margin-left: 550px;margin-bottom: 10px">Add New</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel1">Add New</h5>
